...
class CompetitionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create competition" do
    assert_difference('Competition.count') do
      post competitions_url, params: { competition: { date: @competition.date, komanda1_id: @competition.komanda1_id, komanda2_id: @competition.komanda2_id } }
    end
  ...
  test "should update competition" do
    patch competition_url(@competition), params: { competition: { date: @competition.date, komanda1_id: @competition.komanda1_id, komanda2_id: @competition.komanda2_id } }
